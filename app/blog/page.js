    ...
    <div className="flex flex-col">
      <div className="flex flex-col justify-center px-16 py-4 w-full text-base leading-6 bg-white border-b border-solid border-b-[color:var(--Border-primary,#000)] max-md:px-5 max-md:max-w-full">
        <div className="flex gap-5 justify-between items-center w-full max-md:flex-wrap max-md:mr-1 max-md:max-w-full">
          <img
            loading="lazy"
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/72b30d90149162b25158d86534de979978117f16b0e7c97851b51651cc0fe6aa?apiKey=074c83f0827040edbff71f710b0abb50&"
      ...
      <div className="flex flex-col items-center px-16 py-12 w-full bg-white max-md:px-5 max-md:max-w-full">
        <div className="mt-16 text-base font-semibold leading-6 text-center text-black max-md:mt-10">
          Latest
        </div>
